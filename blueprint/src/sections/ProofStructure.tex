...
\end{theorem}
\begin{proof}
    \uses{lem:ABASubst, lem:ABACore, lem:pfs-transitive}
    By transitivity of probabilistic forward simulation (Lemma~\ref{lem:pfs-transitive}), chain \ref{lem:ABACore} with \ref{lem:ABASubst} by transitivity.
\end{proof}
...
\end{theorem}
\begin{proof}
    \uses{lem:WCCSubst, lem:WCCCore, lem:pfs-transitive}
    By transitivity of probabilistic forward simulation (Lemma~\ref{lem:pfs-transitive}), chain \ref{lem:WCCCore} with \ref{lem:WCCSubst} by transitivity.
\end{proof}
...
\end{theorem}
\begin{proof}
    \uses{lem:GatherSubst, lem:GatherCore, lem:pfs-transitive}
    By transitivity of probabilistic forward simulation (Lemma~\ref{lem:pfs-transitive}), chain \ref{lem:GatherCore} with \ref{lem:GatherSubst} by transitivity.
\end{proof}
...
\end{theorem}
\begin{proof}
    \uses{lem:RSDSubst, lem:RSDCore, lem:pfs-transitive}
    By transitivity of probabilistic forward simulation (Lemma~\ref{lem:pfs-transitive}), chain \ref{lem:RSDCore} with \ref{lem:RSDSubst} by transitivity.
\end{proof}
